...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChattyClientSaysHello = channel.stream_unary(
                ...
                request_serializer=helloworld__pb2.HelloRequest.SerializeToString,
                response_deserializer=helloworld__pb2.DelayedReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ChattyClientSaysHello': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=helloworld__pb2.HelloRequest.FromString,
                    response_serializer=helloworld__pb2.DelayedReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def ChattyClientSaysHello(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            '/greet.Greeter/ChattyClientSaysHello',
            helloworld__pb2.HelloRequest.SerializeToString,
            helloworld__pb2.DelayedReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
